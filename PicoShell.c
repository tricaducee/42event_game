...
/*   Updated: 2022/11/22 14:57:06 by event            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	else if (ac == 2)
	{
		...
		if (key_val == 1)
		{
			if(level_up(key_val))
			{
				...
				{
					execve("/Users/event/.bin/activity_script", NULL, get_data(NULL)->env);
					exit (1);
				}
				else
					wait(NULL);
		...
		else if (key_val == 3)
		{
			if (level_up(key_val))
			{
				...
				{
					execve("/Users/event/.bin/remove_me_script", NULL, get_data(NULL)->env);
					exit (1);
				}
				else
					wait(NULL);
